...
class Method_7_View(tk.Toplevel):
    ...
    def initUI(self):
        ...
        mainLabel = tk.Label(self, text='Измерение коэффициента влияния нестабильности источников питания на напряжение и ЭДС смещения нуля ОУ', font='Regular')
        ...
        # 2 Подача постоянного напряжения источников G1, G2, G5
        voltage1Label = tk.Label(self, text='2. Подайте напряжение от источников G1, G2, G5')
